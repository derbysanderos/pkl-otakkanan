  ...
  return (
    <aside className="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
      <div className="py-4 text-gray-500">
        <button className="ml-6 text-lg font-bold text-gray-800 block">
          <img src="https://msib6.sigarda.com/assets/img/logo.png" alt="" className="w-44" />
        </button>
        <ul className="mt-6">
          ...
          <li className="relative px-6 py-3">
            <Link
              to={"/admin/shift-change-request"}
              className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800"
            >
              <FaBusinessTime size={20} />
              <span className="ml-4">Shift Change Request</span>
            </Link>
          </li>
        </ul>
      </div>
