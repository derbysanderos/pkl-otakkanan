    ...
    <main className="h-full overflow-y-auto bg-gray-50">
      <div className="container grid px-6 mx-auto">
        <div className="my-6 flex justify-between items-center">
          <h2 className="text-2xl font-semibold text-gray-700">Tabel Project</h2>
          <button
          ...
          <div className="w-full overflow-x-auto bg-white p-4">
            <div className="dt-container dt-empty-footer">
                    ...
                    <tbody className="divide-y text-xs text-gray-600">
                      {paginatedProjects.map((p, index) => (
                        <tr key={index} className="h-10">
                          <td className="text-center py-[8px] px-[10px]">{p.id}</td>
                          <td className="text-center py-[8px] px-[10px]">{p.name}</td>
                          <td className="text-center py-[8px] px-[10px]">{p.point}</td>
                          <td className="text-center py-[8px] px-[10px]">{p.deadline}</td>
                          <td className="text-center py-[8px] px-[10px]">
                            <div className="flex items-center">
                              ...
                              <span className="ml-2 text-sm font-medium">{p.progress}</span>
                            </div>
                          </td>
                          <td className="text-center py-[8px] px-[10px]">{p.status}</td>
                          <td className="text-center py-[8px] px-[10px]">
              ...
              <div className="flex justify-between mx-10 my-5">
                <div>
                  <p>
                    Showing {paginatedProjects.length} of {filter.length} entries
                  </p>
                </div>
                <div className="flex items-center gap-5">
                  ...
                  {[...Array(totalPages)].map((_, i) => (
                    <button
                      ...
                      className={`px-2 py-1 ${currentPage === i + 1 ? "bg-gray-300" : "bg-white"}`}
                    >
                      {i + 1}
                    </button>
                  ))}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-[50%]">
        <h2 className="text-xl font-bold mb-4">
          {action === "add" ? "Add Project" : action === "edit" ? "Edit Project" : "View Project"}
        </h2>
