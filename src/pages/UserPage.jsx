                    ...
                    <tbody className="divide-y text-xs text-gray-600">
                      {paginatedUsers.map((u, index) => (
                        <tr key={index} className="h-10">
                          <td className="text-center py-[8px] px-[10px]">{u.id}</td>
                          <td className="text-center py-[8px] px-[10px]">{u.name}</td>
                          <td className="text-center py-[8px] px-[10px]">{u.role}</td>
                          <td className="text-center py-[8px] px-[10px]">{u.email}</td>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-[50%]">
        <h2 className="text-xl font-bold mb-4">
          {action === "add" ? "Add User" : action === "edit" ? "Edit User" : "View User"}
        </h2>
