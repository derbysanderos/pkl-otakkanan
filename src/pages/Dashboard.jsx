...
import { FaUsers, FaFileCode, FaClipboardList, FaClipboardCheck } from "react-icons/fa";
      ...
      <div className="container mx-auto px-6 py-6">
        ...
        <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="flex items-center p-4 bg-white rounded-lg shadow-lg border-2 border-gray-100">
            ...
            <div>
              <p className="mb-2 text-sm font-medium text-gray-600">Project planning</p>
          ...
          <div className="flex items-center p-4 bg-white rounded-lg shadow-lg border-2 border-gray-100">
            ...
            <div>
              <p className="mb-2 text-sm font-medium text-gray-600">Project Ongoing</p>
          ...
          <div className="flex items-center p-4 bg-white rounded-lg shadow-lg border-2 border-gray-100">
            ...
            <div>
              <p className="mb-2 text-sm font-medium text-gray-600">Project done</p>
              <p className="text-lg font-semibold text-gray-700">0</p>
            </div>
          </div>
        </div>

        <h2 className="text-2xl font-semibold text-gray-700 mb-4 mt-10">Chart</h2>
        <div className="flex gap-6">
          <div className="w-1/3 p-4 bg-white rounded-lg shadow-lg border-2 border-gray-100">
            <h4 className="mb-4 font-semibold text-gray-800">Total users by gender</h4>
          ...
          <div className="w-2/3 p-4 bg-white rounded-lg shadow-lg border-2 border-gray-100">
            <h4 className="mb-4 font-semibold text-gray-800">Number of Projects Per Month</h4>
