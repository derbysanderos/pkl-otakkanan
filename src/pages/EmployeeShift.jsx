                    ...
                    <tbody className="divide-y text-xs text-gray-600">
                      {paginatedShifts.map((s, index) => (
                        <tr key={index} className="h-10">
                          ...
                          <td className="text-center py-[8px] px-[10px]">{s.start_hour}</td>
                          <td className="text-center py-[8px] px-[10px]">{s.end_hour}</td>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-[50%]">
        <h2 className="text-xl font-bold mb-4">{action === "add" ? "Add Shift" : "Edit Shift"}</h2>
